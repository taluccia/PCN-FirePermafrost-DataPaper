...
```{r}
data = read_csv("../outputs/era5Clean/ValidationDataHollowayBreenERA5.csv")
```
...
```{r}
write.csv(dataCombine, file = "../outputs/validationPredict/validationPredictHollowayBreen.csv", row.names=FALSE)
```
