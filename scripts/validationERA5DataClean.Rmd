---
title: "Validation ERA5 Land Clean"
author: "Anna Talucci"
date: "2024-09-20"
...
ERA5 Land data was extract by year
# Packages
...
```{r}
f <- list.files(path = "../data/ERA5Validation/",
...
selectColDf = function(x)  {
  x %>%
    dplyr::select(EXTENT:year,  contains("temperature_2m")) %>%
...
```{r}
write.csv(combineAll,file = "../outputs/era5Clean/ValidationDataHollowayBreenERA5.csv", row.names = FALSE)
```
