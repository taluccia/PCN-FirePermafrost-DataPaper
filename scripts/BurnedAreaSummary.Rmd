...
(cumAreaBurned = ggplot() +
 ...
 geom_sf(data = selectCntry_hexBa, color = "gray75", aes(fill=as.factor(ba_binClass))) +
  scale_fill_manual(values = c( '#FDE0C5FF','#F8B58BFF','#F2855DFF','#EB4A40FF'),name = "Cummulative area burned\nfrom 2002-2022\nin thousands of hectares",  label = c("<10","10-100","100-1000",">1000")) +
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/CummulativeAreaBurnedMap.png", plot = cumAreaBurned, dpi = 600, width = 6, height = 6, bg='white')
```