...
```{r}
dataFinal = read_csv("../data/dataCube/PermafrostFireDatacubeFinal.csv")
```
...
```{r}
( 
  resCentroid = bind_rows(res02, res03, res04, res05, res06, res07, res08, res09, res10, res11, res12, res13) %>% 
    rename(geometry = x)
)
```
