...
( plot_na_combDis = ggplot(northAmer, aes(predDepth, colour = resName, lintype=distur)) +
...
( plot_na = ggplot(northAmer, aes(predDepth, colour = resName, lintype=distur)) +
  geom_freqpoly(binwidth = 10) +
  facet_grid(vars(resBiome), vars(distur),  scales = "free_y") +
   scale_color_manual(values = c('#ff7f00', '#1f78b4', "#00bfa0", '#33a02c','#a6cee3', "#dc0ab4", '#bebada', '#CC6677'), name="Ecozones") +
  comp_theme +
  theme(strip.background = element_rect(color="white", fill="white", size=1.5, linetype="solid"),
          strip.text.x = element_text(size = 8), 
...
```{r}
( plot_asia_combDis =  ggplot(asia, aes(predDepth, colour = resName)) +
  geom_freqpoly(binwidth = 10, aes(linetype = distur)) +
  facet_wrap(vars(resBiome), scales = "free") +
    scale_linetype_manual(values=c("solid", "dashed")) +
...
```{r}
( DataDistributuionMap = ggdraw(xlim = c(0, 8), ylim = c(0, 4)) +
    draw_plot(leftSide, x = 0, y = 0, width = 4, height = 4) + 
  draw_image("../figures/EcozoneMapAndLegendBottom.png", scale = 1.05, x = 4.05, y = 0, width = 4, height = 4) +
  draw_plot_label(
  label="C",
  x = 3.9,
  y = 4.01)
...
( DataDistributuionMap_CombDist = ggdraw(xlim = c(0, 9), ylim = c(0, 5)) +
  ...
  draw_image("../figures/EcozoneMapAndLegendBottom.png", scale = 1.05, x = 5.05, y = 1.1, width = 4, height = 4) +
  draw_plot_label(
  label="C",
  x = 5.4,
  y = 5.01)
...
```{r}
( DataDistributuionMap_CombDist = ggdraw(xlim = c(0, 6), ylim = c(0, 7)) +
    draw_plot(leftSide_combineDist, x = 0, y = 3, width = 6, height = 4) + 
  draw_image("../figures/EcozoneMapAndLegendBottom.png", scale = 1.05, x = 2, y = 0, width = 4, height = 4) +
  draw_plot_label(
  label="C",
  x = 2.,
  y = 2)
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/EcozoneDataDistributionMap.png", plot = DataDistributuionMap, dpi = 600, width = 8, height = 4.5, bg='white')
```

```{r eval=FALSE, include=FALSE}
ggsave("../figures/EcozoneDataDistributionDisturbMap.png", plot = DataDistributuionMap_CombDist, dpi = 600, width = 8, height = 4.5, bg='white')
```
